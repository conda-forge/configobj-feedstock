...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/configobj-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/configobj-feedstock)
...
Once the `conda-forge` channel has been enabled, `configobj` can be installed with:

```
conda install configobj
```

It is possible to list all of the versions of `configobj` available on your platform with:
